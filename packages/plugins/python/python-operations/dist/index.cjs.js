...
${visitorPluginCommon.indentMultiline(this.getExecuteFunctionSignature(true, node), 1)}
${visitorPluginCommon.indentMultiline(this.getGQLVar(node), 2)}
${visitorPluginCommon.indentMultiline(this.getResponseClass(node), 2)}
${visitorPluginCommon.indentMultiline(this.getExecuteFunctionBody(true, node), 2)}
`;
    }
}
